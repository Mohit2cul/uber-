        ...
        <div>
          ...
          <form onSubmit={submitHandler} className='flex flex-col p-6 lg:w-[40%] w-full mx-auto bg-[#f7f7f7] '>
            ...
            <div className='flex gap-4'>
              <input className=' py-2 px-3 rounded-md w-1/2 text-md font-medium border-[2px] solid black' type="text" placeholder="First name" required />
              <input className=' py-2 px-3 rounded-md w-1/2 text-md font-medium border-[2px] solid black' type="text" placeholder="Last name" required />
            </div>
            <h3 className='text-xl font-semibold mb-2 mt-4'>What's your Email?</h3>
            <input className='mb-3 py-2 px-3 rounded-md w-full text-md font-medium border-[2px] solid black' type="email" placeholder="email@example.com" required />
            <h3 className='text-xl font-semibold mb-2'>Password</h3>
            <input className='mb-3 py-2 px-3  rounded-md w-full text-md font-medium border-[2px] solid black' type="password" placeholder="Password" />
